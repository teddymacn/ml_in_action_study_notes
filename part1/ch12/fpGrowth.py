...
'''
# 12.2.1 the FP-tree data structure
class treeNode:
...
# 12.2.2 FP-tree creation functions
...
# 12.2.2 test createTree on simple dataset
def testCreateTree():
    simpDat = loadSimpDat()
    initSet = createInitSet(simpDat)
    myFPtree, myHeaderTab = createTree(initSet, 3)
    myFPtree.disp()
    return myFPtree, myHeaderTab
...
# 12.3.2 mineTree function recursively finds frequent itemsets
...
# 12.3.2 test mineTree on simple dataset
def testSimpleDataMineTree():
    freqItems = []
    myFPtree, myHeaderTab = testCreateTree()
